...
export default function ProfileForm() {
  ...
  // const [_isProfileCreated, setIsProfileCreated] = useState(false);
  ...
  //   const newErrors: { [key: string]: string } = validateProfileForm({
  //     ...formData,
  //     [name]: value,
  //   });
  ...
  // const [developerPicture, setDeveloperPicture] = useState<File | undefined>(
  //   undefined
  // );
  // const previewURL = developerPicture
  //   ? URL.createObjectURL(developerPicture)
  ...
  return (
    ...
    //       <p>
    //         {isProfileCreated
    //           ? "Please update the fields below to update your profile."
    //           : "Please complete the fields below to create your profile."}
    //       </p>
    //     </div>
